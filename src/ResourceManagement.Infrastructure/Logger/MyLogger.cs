namespace ResourceManagement.Infrastructure.Logger
{
    ...
    public class MyLogger<TModel> : IMyLogger<TModel>
    {
        ...
        public MyLogger(ILogger<TModel> logger) => this.logger = logger;
        ...
        public void Error(string message, Exception exception) => this.logger.LogError(message, exception);

        public void Fatal(string message) => this.logger.LogCritical(message);

        public void Fatal(string message, Exception exception) => this.logger.LogCritical(message, exception);

        public void Trace(string message) => this.logger.LogTrace(message);
    }
}
